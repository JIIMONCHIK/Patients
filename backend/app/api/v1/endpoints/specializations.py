...
from backend.app.schemas.specialization import Specialization, SpecializationCreate, SpecializationUpdate
from backend.app.crud.specialization import specialization
