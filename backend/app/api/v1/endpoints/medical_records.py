...
from backend.app.schemas.medical_record import MedicalRecord, MedicalRecordCreate, MedicalRecordUpdate
from backend.app.crud.medical_record import medical_record
